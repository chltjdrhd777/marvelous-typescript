let number1 = Math.ceil(Math.random()*9); //Math.ceil = return the closest and greatest intergral like Math.ceil(21.4) = 22
let number2 = Math.ceil(Math.random()*9);
let result = number1*number2;

const word = document.createElement('div'); // which means that I would make new "div" tag
